...
class ZhillPipeline(object):
    ...
    def process_item(self, item, spider):
        self.cursor.execute(self.sql, (item['job1'], item['job11'], item['job2'], item['job3'], item['job4'], item['job5'], item['job6'], item['job7']))
        self.conn.commit()
    ...
    def open_spider(self, spider):  # 3
        ...
        self.sql = 'insert into zhill values(%s,%s,%s,%s,%s,%s,%s,%s)'
